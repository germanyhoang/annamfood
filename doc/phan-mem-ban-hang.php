          ...
          <table class="table table-hover table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td>71309005</td>
                <td>Nước cốt phở (gói nhỏ)</td>
                <td><img src="../img/anhnuoccotpho.png" alt="" width="50px;"></td>
              ...
              <tr>
                ...
                <td><img src="../img/phokhoannam.png" alt="" width="50px;"></td>
                <td><input class="so--luong1" type="number" value="1"></td>
                <td>35.000 </td>
              ...
              <tr>
                ...
                <td><img src="../img/vungvangannam.jpg" alt="" width="50px;"></td>
              ...
              <tr>
                ...
                <td><img src="../img/vungdenannam.png" alt="" width="50px;"></td>
                <td><input class="so--luong1" type="number" width="30" value="1"></td>
                <td>40.000 </td>
                <td style="text-align: center; vertical-align: middle;">
                  <button class="btn btn-primary btn-sm trash" type="button" title="Xóa"><i class="fas fa-trash-alt"></i></button>
        ...
        <div class="tile">
          ...
          <div class="row">
            ...
            <div class="form-group  col-md-6">
              ...
              <p class="control-all-money-tamtinh">=  VNĐ</p>
            </div>
            <div class="form-group  col-md-6">
            ...
            <div class="form-group  col-md-6">
              ...
              <p class="control-all-money-total">=  VNĐ</p>
            </div>
            <div class="form-group  col-md-6">
            ...
            <div class="form-group  col-md-12">
              ...
              <p class="control-all-money">  VNĐ</p>
            </div>
            <div class="tile-footer col-md-12">
              ...
              <a class="btn btn-secondary luu-va-in" href="../doc/quanly.php?page=index">Quay về</a>
            </div>
          </div>
        </div>
        </div>
